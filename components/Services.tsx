...
import { TrendingUp, Database, Users, Globe, Mic, ArrowUpRight, Box, ChartBar, Layers, Share2 } from 'lucide-react';
...
const ServiceCard: React.FC<{ 
  ...
  <motion.div
    ...
    className={`bento-card p-8 flex flex-col justify-between group relative overflow-hidden ${className}`}
  >
    {bgImage && (
    ...
    <div className="absolute inset-0 bg-gradient-to-br from-blue-600/0 to-transparent opacity-0 group-hover:from-blue-600/10 group-hover:opacity-100 transition-all duration-500" />
    
    <div className="relative z-10 flex justify-between items-start mb-8">
      <div className="p-3 bg-white/5 rounded-lg text-white group-hover:bg-blue-600 group-hover:text-white transition-all duration-300 border border-white/5">
        {icon}
      </div>
    ...
    <div className="relative z-10 mt-auto">
      <h3 className="text-2xl font-bold uppercase font-['Oswald'] mb-3 group-hover:text-blue-400 transition-colors">{title}</h3>
    ...
    <section id="services" className="py-32 bg-[#050505] border-t border-white/5 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 md:px-12">
        ...
        <motion.div 
          ...
          className="grid grid-cols-1 md:grid-cols-4 gap-4 auto-rows-[minmax(280px,auto)]"
        >
          
          {/* Main Feature - Supply Chain (Large) */}
          <motion.div 
            variants={itemVariants}
            className="md:col-span-2 md:row-span-2 bento-card p-8 md:p-12 flex flex-col justify-end group relative overflow-hidden bg-blue-950/10"
          >
             ...
             <div className="relative z-10 mb-auto pt-4">
                <div className="bg-blue-600 w-12 h-12 flex items-center justify-center rounded-lg mb-6 text-white">
                  <Layers size={24} />
                </div>
             </div>

             <div className="relative z-10">
                <h3 className="text-3xl md:text-5xl font-bold uppercase font-['Oswald'] mb-6 text-white leading-tight">
